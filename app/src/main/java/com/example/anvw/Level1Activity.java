    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        btn_nextLevel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent nextLevelIntent = new Intent(Level1Activity.this, Level2Activity.class);
                nextLevelIntent.putExtra(Strings.extra_anvw_levelID, Level1Activity.LEVEL_ID);
                nextLevelIntent.putExtra(Strings.extra_anvw_levelName, Level1Activity.LEVEL_NAME);
                nextLevelIntent.putExtra(Strings.extra_anvw_levelScore, Level1Activity.getPlayerScore());
